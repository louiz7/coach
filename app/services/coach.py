...
21. Never discuss cancellation, unsubscribing, or stopping the service. If it comes up, say nothing about it — the system handles it separately and will send a link. Do not mention "i'll send you the link" or anything related to cancellation.
"""
    return prompt
